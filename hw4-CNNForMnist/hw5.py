...
class nn_mnist_classifier:
    ...
    def backprop(self):
        ...
        fc1_b, dldw_fc1, dldb_fc1 = self.fc1.backprop(mp1_f.reshape(mp1_f.shape[0], -1), ac2_b)
        mp1_b = self.maxpool_layer_1.backprop(ac1_f, fc1_b.reshape(mp1_f.shape))
    ...
    def update_weights(self):
        ...
        self.fc2.update_weights(dLdW=-lr*self.v_w_fc2, dLdb=-lr*self.v_b_fc2)
        self.fc1.update_weights(dLdW=-lr*self.v_w_fc1, dLdb=-lr*self.v_b_fc1)
        self.conv_layer_1.update_weights(dW=-lr*self.v_w_cv1, db=-lr*self.v_b_cv1)
        ########################
        # Q3 ends here
        ########################
